...
- The `make env` command will not fill in your mysql password, so you should add that manually in the `.env` fi;e. Also just verify that the `DB_USER` and `HOST` variables match your mysql host and user - the one you made during the mysql setup in CSC2001F or whenever you set it up.
